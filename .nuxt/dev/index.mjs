...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, readBody, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, getResponseStatusText } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/h3@1.9.0/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/vue-bundle-renderer@2.0.0/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/devalue@4.3.2/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/vue@3.3.10_typescript@5.3.2/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/@unhead+ssr@1.8.8/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/ofetch@1.3.3/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/destr@2.0.2/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/unenv@1.8.0/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/scule@1.1.1/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/defu@6.1.3/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/ohash@1.1.3/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/ufo@1.3.2/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/unstorage@1.10.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/unstorage@1.10.1/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/radix3@1.1.0/node_modules/radix3/dist/index.mjs';
import { generateJSON } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/@intlify+bundle-utils@5.5.0_vue-i18n@9.3.0-beta.17/node_modules/@intlify/bundle-utils/index.mjs';
import { relative, join } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/pathe@1.1.1/node_modules/pathe/dist/index.mjs';
import { version, unref } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/vue@3.3.10_typescript@5.3.2/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/unhead@1.8.8/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/lucas/Desktop/cubos/node_modules/.pnpm/@unhead+shared@1.8.8/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "apiBaseUrl": "https://movies-proxy.vercel.app",
    "i18n": {
      "experimental": {
...
const serverAssets = [{"baseName":"server","dir":"/Users/lucas/Desktop/cubos/server/assets"}];
...
storage.mount('i18n', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/lucas/Desktop/cubos/.nuxt/i18n","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/lucas/Desktop/cubos","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/lucas/Desktop/cubos/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/lucas/Desktop/cubos/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/lucas/Desktop/cubos/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/lucas/Desktop/cubos/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _1I6mmNLAPy = (function(nitro) {
...
const _1RC2M9 = defineEventHandler(async (event) => {
...
const _pGh9M0 = defineEventHandler(async (event) => {
...
const _lazy_lLpabL = () => Promise.resolve().then(function () { return index$1; });
const _lazy_c90IUX = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api', handler: _lazy_lLpabL, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_c90IUX, lazy: true, middleware: false, method: undefined },
  { route: '/__i18n__/precompile', handler: _1RC2M9, lazy: false, middleware: false, method: "post" },
  { route: '/__i18n__/prerender/:hash', handler: _pGh9M0, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_c90IUX, lazy: true, middleware: false, method: undefined }
];
...
const index = defineEventHandler(() => "Nuxt Movies API");
...
const getClientManifest = () => import('file:///Users/lucas/Desktop/cubos/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/lucas/Desktop/cubos/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
